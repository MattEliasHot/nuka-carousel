...
var Carousel = (0, _createReactClass2.default)({
  ...
  setActiveBreakpoint: function setActiveBreakpoint(activeBreakpoint) {
    var settings = activeBreakpoint.settings;
    ...
    this.setState(_extends({ activeBreakpoint: activeBreakpoint }, settings));
  },
  ...
  nextSlide: function nextSlide() {
    ...
    if (this.props.wrapAround) {
      ...
      this.goToSlide(Math.min(scrollFromCurrent, childrenCount - slidesToShow));
    }
  },
  ...
  formatChildren: function formatChildren(children) {
    ...
    var _state3 = this.state,
        ...
        slidesToShow = _state3.slidesToShow;

    var maxSlide = currentSlide + slidesToShow;
