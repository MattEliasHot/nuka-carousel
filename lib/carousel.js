...
var Carousel = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    breakpoints: _propTypes2.default.arrayOf(_propTypes2.default.object),
    classNameSlide: _propTypes2.default.string,
    ...
    slideAll: _propTypes2.default.bool,
  ...
  getInitialState: function getInitialState() {
    var breakpoints = this.sortBreakpoints();
    var defaultBreakpoint = breakpoints[0];
  ...
  componentWillMount: function componentWillMount() {
    this.findAndSetActiveBreakpoint();
  ...
  sortBreakpoints: function sortBreakpoints() {
    var slideAll = this.props.slideAll;


    return this.props.breakpoints.sort(function (a, b) {
  ...
  findAndSetActiveBreakpoint: function findAndSetActiveBreakpoint() {
  ...
  setActiveBreakpoint: function setActiveBreakpoint(activeBreakpoint) {
  ...
  slidesToAdvance: function slidesToAdvance(current) {
  ...
  nextSlide: function nextSlide() {
    ...
    var childrenCount = _react2.default.Children.count(this.props.children);
    var scrollFromCurrent = currentSlide + slidesToScroll;
    scrollFromCurrent = scrollFromCurrent === childrenCount ? 1 : currentSlide + slidesToScroll;
    ...
    if (this.props.wrapAround) {
      ...
      this.goToSlide(Math.min(this.scrollFromCurrent(), childrenCount - slidesToShow));
    }
  },
  previousSlide: function previousSlide() {
    ...
    if (this.props.wrapAround) {
      this.goToSlide(currentSlide === 0 ? scrollFromCurrent : Math.max(0, scrollFromCurrent));
    } else {
      this.goToSlide(Math.max(0, scrollFromCurrent));
    }
  },
  ...
  formatChildren: function formatChildren(children) {
    ...
    var _state3 = this.state,
        ...
        slidesToScroll = _state3.slidesToScroll;

    var maxSlide = currentSlide + slidesToScroll;
    var endSlide = maxSlide % _react2.default.Children.count(children);

    return _react2.default.Children.map(children, function (child, index) {
      var isActive = index >= currentSlide && index < maxSlide || index <= endSlide && endSlide < currentSlide;

      var activeClass = isActive ? 'slider-slide-active' : '';
      var currentClass = index === currentSlide ? 'slider-slide-current' : '';

      return _react2.default.createElement(
        'li',
        {
          className: 'slider-slide ' + self.props.classNameSlide + ' ' + currentClass + ' ' + activeClass,
  ...
  setInitialDimensions: function setInitialDimensions() {
    ...
    slideHeight = this.props.initialSlideHeight ? this.props.initialSlideHeight * this.state.slidesToShow : 0;

    frameHeight = slideHeight + this.props.cellSpacing * (this.state.slidesToShow - 1);
  ...
  setDimensions: function setDimensions(props) {
    ...
    if (firstSlide) {
      ...
      slideHeight = this.props.vertical ? firstSlide.offsetHeight * this.state.slidesToShow : firstSlide.offsetHeight;
    } else {
      slideHeight = 100;
    }
